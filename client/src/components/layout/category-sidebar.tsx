    ...
    <aside className="lg:w-1/5 hidden lg:block space-y-6">
          ...
          <div className="flex items-start space-x-3 pb-3 border-b border-gray-100">
            ...
            <div>
              <div className="italic text-gray-700 text-sm">
                "I love the authentic Kenyan products from KuQuza. Fast delivery and excellent quality!"
              </div>
      ...
      <div className="bg-white shadow-sm rounded-lg p-4">
        ...
        <div className="flex items-center space-x-2 mb-3 text-sm">
          ...
          <a href="https://kuquza.co.ke" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
            kuquza.co.ke
          </a>
        </div>
        <Link 
